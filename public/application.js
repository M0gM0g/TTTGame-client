...
var onClickChangePasswordButton = function onClickChangePasswordButton(event) {
  event.preventDefault();
...
var onCreateGame = function onCreateGame(event) {
  event.preventDefault();
  authApi.createGame().then(authUi.createGameSuccess).catch(authUi.createGameFailure);
};
...
var onGetGames = function onGetGames(event) {
  ...
  event.preventDefault();
  authApi.getGames(data).then(authUi.getGamesSuccess).catch(authUi.getGamesFailure);
};
...
var onUpdateGame = function onUpdateGame(event) {
  ...
  event.preventDefault();
  authApi.updateGame(data).then(authUi.updateGamesSuccess).catch(authUi.updateGamesFailure);
};
...
var clearGetGamesMessage = function clearGetGamesMessage() {
...
var signUpError = function signUpError(event) {
...
var clickPasswordButton = function clickPasswordButton(event) {
  $('#change-password').show();
  $('#change-password-form').show();
  $('#change-password-button-only').hide();
};
...
var updateGamesSuccess = function updateGamesSuccess(data) {
  store.game = data.game;
  store.game.id = data.game.id;
  store.game.cells = data.game.cells;
  store.game.over = data.game.over;
